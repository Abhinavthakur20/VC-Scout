...
export function Topbar({
  ...
  return (
    <header className="sticky top-0 z-40 bg-[var(--bg-base)] px-4 py-2 md:ml-[18.75rem]">
      <div className="ui-panel app-frame rounded-2xl">
        <div className="flex h-16 items-center gap-3 px-4">
          ...
          <div className="relative flex-1">
            ...
            />
            <span className="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 rounded-md border border-slate-200 bg-slate-50 px-1.5 py-0.5 text-[10px] text-slate-500">
              {hint}
            </span>
          </div>

          <Button variant="secondary" size="icon" aria-label="Notifications" className="hidden sm:inline-flex">
